...
class KeyLetter{
    ...
    func getEngLetter() -> [[KeyModel]]{
        return [
            [KeyModel(keyType: .letter,lt_txt: "w",rt_txt: "⠈",rb_txt: "q", lt_color: textColor, lt_textsize: engSmallTextSize, rt_color: textColor,rb_color:subletter_Color,rb_textsize: engSmallTextSize, backgroundColor: backgroundColor, height:key_height, width: key_width,tag: 0),
    ...
    func getEngShiftLetter() -> [[KeyModel]]{
        return   [
            [KeyModel(keyType: .letter,lt_txt: "W",rt_txt: "⠈",rb_txt: "Q", lt_color: textColor, lt_textsize: engLargeTextSize,rt_color: textColor, rb_color:subletter_Color,rb_textsize: engLargeTextSize, backgroundColor: backgroundColor,height:key_height, width: key_width,tag: 16),
